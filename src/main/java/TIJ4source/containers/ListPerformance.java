package TIJ4source.containers;//: containers/ListPerformance.java
// Demonstrates performance differences in Lists.
// {Args: 100 500} Small to keep build testing short
import java.util.*;

import TIJ4source.concurrency.Tester;
...
public class ListPerformance {
  ...
  static class ListTester extends TIJ4source.concurrency.Tester<List<Integer>> {
  ...
  public static void main(String[] args) {
    if(args.length > 0)
      TIJ4source.concurrency.Tester.defaultParams = TestParam.array(args);
    // Can only do these two tests on an array:
    TIJ4source.concurrency.Tester<List<Integer>> arrayTest =
      new TIJ4source.concurrency.Tester<List<Integer>>(null, tests.subList(1, 3)){
    ...
    arrayTest.timedTest();
    TIJ4source.concurrency.Tester.defaultParams= TestParam.array(
    ...
    TIJ4source.concurrency.Tester.fieldWidth = 12;
    TIJ4source.concurrency.Tester<LinkedList<Integer>> qTest =

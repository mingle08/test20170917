package TIJ4source.gui;//: gui/InterruptableLongRunningCallable.java
...
import TIJ4source.concurrency.Task;
import net.mindview.util.*;
import static TIJ4source.net.mindview.util.SwingConsole.*;

class CallableTask extends TIJ4source.concurrency.Task

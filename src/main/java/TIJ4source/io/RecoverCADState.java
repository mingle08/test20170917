package TIJ4source.io;//: io/RecoverCADState.java
// Restoring the state of the pretend CAD system.
// {RunFirst: StoreCADState}
import TIJ4source.generics.Shape;
import TIJ4source.gui.List;
...
public class RecoverCADState {
  ...
  public static void main(String[] args) throws Exception {
    ...
    TIJ4source.gui.List<Class<? extends TIJ4source.generics.Shape>> shapeTypes =
      (TIJ4source.gui.List<Class<? extends TIJ4source.generics.Shape>>)in.readObject();
    Line.deserializeStaticState(in);
    TIJ4source.gui.List<TIJ4source.generics.Shape> shapes = (List<TIJ4source.generics.Shape>)in.readObject();

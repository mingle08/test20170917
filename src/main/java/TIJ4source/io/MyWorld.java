package TIJ4source.io;//: io/MyWorld.java
import TIJ4source.gui.List;

import java.io.*;
import java.util.*;
import static TIJ4source.net.mindview.util.Print.*;
...
public class MyWorld {
  ...
  throws IOException, ClassNotFoundException {
    ...
    TIJ4source.gui.List<Animal> animals = new ArrayList<Animal>();
    ...
    TIJ4source.gui.List
      animals1 = (TIJ4source.gui.List)in1.readObject(),
      animals2 = (TIJ4source.gui.List)in1.readObject(),

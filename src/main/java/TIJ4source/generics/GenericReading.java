package TIJ4source.generics;//: generics/GenericReading.java
...
public class GenericReading {
  ...
  static List<TIJ4source.initialization.Apple> apples = Arrays.asList(new TIJ4source.initialization.Apple());
  static List<Fruit> fruit = Arrays.asList(new Fruit());
  // A static method adapts to each call:
  static void f1() {
    TIJ4source.initialization.Apple a = readExact(apples);
